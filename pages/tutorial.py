...
st.write(
    "Go to [intranet.rsu.ac.th](https://intranet.rsu.ac.th/suWeb/SignIn.aspx). "
    "Login with your student ID (u6xxxxxx) and password. "
    "Make sure you've selected Thai language version (TH)."
)
st.image("media/images/step2.png", use_container_width=True)

# Step 2
st.header("Step 2: Select Grades By Curriculum Structure")
st.write("Select Grade Information > Grades By Curriculum Structure.")
st.image("media/images/step3.png", use_container_width=True)

# Step 3
st.header("Step 3: Print")
